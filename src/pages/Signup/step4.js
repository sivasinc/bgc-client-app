...
const Step4 = ({ selectedProfile, handleSelectChange, year, value, handleRadioChange, handleInputChange, userProfile }) => {
 ...
 <RadioGroup aria-label="workType" name="workType" value={value} onChange={handleRadioChange}>
   <FormControlLabel value="fulltime" control={<Radio color="default"/>} label="Full Time" />
   <FormControlLabel value="partTime" control={<Radio color="default"/>} label="Part Time" />
 </RadioGroup>
</FormControl>
   </div>
      )}
